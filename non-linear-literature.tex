...
\includegraphics[width=\textwidth,height=8cm]{"figures/non-lineardiag"}
  ...
  \begin{figure}[h!]
\includegraphics[width=\textwidth,height=0.55\textwidth]{"figures/33"}
  \caption{non-linearity is added in secondary system.}
  \label{fig:33}
  \end{figure}
  \begin{figure}[h!]
\includegraphics[width=\textwidth,height=0.55\textwidth]{"figures/34"}
